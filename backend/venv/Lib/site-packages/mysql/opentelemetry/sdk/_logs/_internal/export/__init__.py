...
class BatchLogRecordProcessor(LogRecordProcessor):
    ...
    def __init__(
        ...
        self._queue = collections.deque(
            [], max_queue_size)  # type: Deque[LogData]
    ...
    def worker(self):
        ...
        while not self._shutdown:
            ...
            timeout = self._schedule_delay_millis / \
                1e3 - ((end_ns - start_ns) / 1e9)
    ...
    def _default_schedule_delay_millis():
        try:
            return int(
                environ.get(OTEL_BLRP_SCHEDULE_DELAY,
    ...
    def _default_export_timeout_millis():
        try:
            return int(
                environ.get(OTEL_BLRP_EXPORT_TIMEOUT,
