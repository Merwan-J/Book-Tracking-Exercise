...
CNX_POOL_ARGS: Tuple[str, str, str] = (
...
class CharacterSet:
    ...
    def __init__(self) -> None:
        ...
        self._desc: List[Optional[Tuple[str, str, bool]]
    ...
    def get_info(self, setid: int) -> Tuple[str, str]:
        ...
        try:
            ...
            raise ProgrammingError(
                f"Character set '{setid}' unsupported") from None
    ...
    def get_charset_info(
        ...
        """
        info: Optional[Union[Tuple[str, str, bool],
        ...
        if isinstance(charset, int):
            try:
                ...
                raise ProgrammingError(
                    f"Character set ID {charset} unknown") from err
