...
NAMED_TUPLE_CACHE: weakref.WeakValueDictionary[Any,
...
class MySQLConnectionAbstract(ABC):
    ...
    def __init__(self) -> None:
        ...
        self._webauthn_callback: Optional[Union[str,
    ...
    def config(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            raise InterfaceError(
                "TCP/IP port number should be an integer") from err
        ...
        if "kerberos_auth_mode" in config and config["kerberos_auth_mode"] is not None:
            if not isinstance(config["kerberos_auth_mode"], str):
                raise InterfaceError(
                    "'kerberos_auth_mode' must be of type str")
        ...
        if self._webauthn_callback:
            self._validate_callable(
                "webauth_callback", self._webauthn_callback, 1)
    ...
    def set_charset_collation(
        ...
        if self.converter:
            self.converter.set_charset(
                charset_name, character_set=self._character_set)
    ...
    def connect(self, **kwargs: Any) -> None:
        ...
        if not self._client_flags & ClientFlag.CAN_HANDLE_EXPIRED_PASSWORDS:
            ...
            try:
                ...
                self.cmd_query(
                    f"SET PASSWORD = '{self._password1 or self._password}'")
