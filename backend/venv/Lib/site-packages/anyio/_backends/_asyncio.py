...
class CancelScope(BaseCancelScope):
    ...
    def __exit__(
        ...
        if exc_val is not None:
            exceptions = (
                exc_val.exceptions if isinstance(
                    exc_val, ExceptionGroup) else [exc_val]
            )
...
class TaskGroup(abc.TaskGroup):
    ...
    def _filter_cancellation_errors(
        ...
        for exc in exceptions:
            if isinstance(exc, ExceptionGroup):
                new_exceptions = TaskGroup._filter_cancellation_errors(
                    exc.exceptions)
    ...
    def _spawn(
        ...
        foreign_coro = not hasattr(
            coro, "cr_frame") and not hasattr(coro, "gi_frame")
